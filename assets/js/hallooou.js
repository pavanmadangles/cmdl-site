...
$(function() {
    ...
    $("#contactForm").validate({
        ...
        submitHandler: function(element) {
            ...
            $.ajax({
                url: 'https://api.parse.com/1/classes/register',
                type: type,
                headers: {'X-Parse-Application-Id':'MiioY4yQ5XzmI5I0lpSjjpltnKe9nOyai1ojrz7E','X-Parse-REST-API-Key':'SOLHnZgNSNwIENp4zkyqHNMXAAcgctxJQjPnDs5z'},
                data: JSON.stringify(data),
                contentType: "application/json",
                success: function(response) {console.log("hitted success");pa = response;
                    if (response) {
                        $("#contactForm").before("<div class='alert alert-success' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>Ah! We got it. Soon we will reach you out :)</div>");
                    ...
                    $("#contactForm").before("<div class='alert alert-danger' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>Ah! Might be Human error :D Try again!</div>");
